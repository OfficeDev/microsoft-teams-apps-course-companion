...
/**
* Component for rendering command bar.
*/
                    ...
                    <Flex.Item push>
                        {windowWidth > Resources.maxWidthForMobileView ?
                            <Button className="filter-button"
                                icon={props.showSolidFilterIcon ?
                                    <Icon iconName="FilterSolid" className="filter-icon-filled" /> :
                                    <Icon iconName="Filter" className="menu-filter-icon" />}
                                content={<Text content={localize("filterText")} className={props.showSolidFilterIcon ? "filter-icon-filled" : ""} />} text onClick={props.onFilterButtonClick} />
                            : <Button className="filter-button" icon={props.showSolidFilterIcon ?
                                <Icon iconName="FilterSolid" className="filter-icon-filled" /> :
                                <Icon iconName="Filter" className="menu-filter-icon" />} iconOnly text
