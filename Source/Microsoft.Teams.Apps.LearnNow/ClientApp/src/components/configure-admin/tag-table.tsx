// <copyright file="tag-table.tsx" company="Microsoft Corporation">
...
/**
* Component for tag table details.
*/
const TagTable: React.FunctionComponent<ITagTableProps> = props => {
    ...
    const userResponsesTableHeader = {
        ...
        items: props.showCheckbox ?
            [
                ...
                {
                    content: <Text weight="regular" content={localize("adminCreateTagLabelText")} />, key: "grade"
                },
    ...
    let UserResponsesTableRows = props.responsesData.map((value: any, index) => (
        {
            ...
            items: props.showCheckbox ?
                [
                    ...
                    { content: <Text content={value.tagName} title={value.subjectName} />, key: index + "2", truncateContent: true },
